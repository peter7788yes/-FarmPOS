...
{
	public class frmCropGuideRange_Mangement : MasterThinForm
	{
		public string cls1 = "";
		...
		public frmCropGuideRange_Mangement(frmEditCommodity fme, int count, string barcode1, string scopeName)
			: base("商品管理")
		{
			fre = fme;
			this.count = count;
			barcode = barcode1;
			_scopeName = "【" + scopeName + "】用藥範圍設定";
			InitializeComponent();
			string[] strWhereParameterArray = new string[1]
			{
				barcode
			};
			label6.Text = _scopeName;
		...
		private void clslit2_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (clslit2.CurrentRow.Index == 0 && clslit2.CurrentRow.Cells[0].Value.ToString().Contains("選入"))
			{
				cropcode = cls1;
				nowlevel = 1;
				frmPestGuideRange_Mangement frmPestGuideRange_Mangement = new frmPestGuideRange_Mangement(this, fre, count, barcode, _scopeName);
				frmPestGuideRange_Mangement.Location = new Point(base.Location.X, base.Location.Y);
				frmPestGuideRange_Mangement.Show();
				Hide();
				return;
			}
		...
		private void clslit4_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
			if (e.RowIndex != -1)
			{
				...
				else
				{
					...
					nowlevel = 4;
					frmPestGuideRange_Mangement frmPestGuideRange_Mangement2 = new frmPestGuideRange_Mangement(this, fre, count, barcode, _scopeName);
					frmPestGuideRange_Mangement2.Location = new Point(base.Location.X, base.Location.Y);
					frmPestGuideRange_Mangement2.Show();
					Hide();
				}
			}
		}
		...
		private void InitializeComponent()
		{
			...
			clslit3.TabIndex = 69;
			clslit3.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(clslit3_CellContentClick);
			...
			label1.TabIndex = 0;
			label1.Text = "Step1\r\n作物選擇";
			btn_back.Font = new System.Drawing.Font("微軟正黑體", 12.75f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 136);
			btn_back.Location = new System.Drawing.Point(872, 123);
			btn_back.Name = "btn_back";
			btn_back.Size = new System.Drawing.Size(97, 33);
			btn_back.TabIndex = 76;
			btn_back.Text = "回上一步";
			...
			base.Name = "frmCropGuideRange_Mangement";
