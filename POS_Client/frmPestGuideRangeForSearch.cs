...
{
	public class frmPestGuideRangeForSearch : MasterThinForm
	{
		public string cls1 = "";
		...
		private frmCropGuideRangeForSearch fcgr;
		...
		public frmPestGuideRangeForSearch(frmCropGuideRangeForSearch fcgr, frmMainShopSimple fms, int count, string barcode)
			: base("收銀作業")
		{
			InitializeComponent();
			if (Program.IsHyweb)
			...
			dtGOODS = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "domManufId,pesticideId,formCode,contents", "hypos_GOODSLST", "GDSNO = {0}", "", null, strWhereParameterArray, CommandOperationType.ExecuteReaderReturnDataTable);
			...
			foreach (DataRow row in dtGOODS.Rows)
			{
				...
				DataTable dataTable = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "distinct pestId", "HyScope", "pesticideId={0} and cropId={1} and formCode={2} and contents={3} AND isDelete in ('N','') ", "", null, strWhereParameterArray2, CommandOperationType.ExecuteReaderReturnDataTable);
				...
				foreach (DataRow row2 in dataTable.Rows)
				{
					...
					DataTable dataTable2 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "distinct cat1,name", "HyBlight", "{0} like '%'||cat1||'%' and cat2 ='' and cat3 ='' and cat4 =''", "", null, strWhereParameterArray3, CommandOperationType.ExecuteReaderReturnDataTable);
		...
		public frmPestGuideRangeForSearch(frmCropGuideRangeForSearch fcgr, frmMainShopSimpleWithMoney fms, int count, string barcode)
			: base("收銀作業")
		{
			InitializeComponent();
			if (Program.IsHyweb)
		...
		private void clslit2_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (clslit2.CurrentRow.Index == 0 && clslit2.CurrentRow.Cells[0].Value.ToString().Contains("選入"))
			{
				...
				{
					frs.addOnecommodity(barcode, cropcode, cls1, dataTable.Rows[0]["name"].ToString(), dataTable2.Rows[0]["name"].ToString());
					Hide();
					frs.Show();
				}
				else
				{
					frsm.addOnecommodity(barcode, cropcode, cls1, dataTable.Rows[0]["name"].ToString(), dataTable2.Rows[0]["name"].ToString());
					Hide();
					frsm.Show();
				}
				return;
			...
			DataTable dataTable3 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "domManufId,pesticideId,formCode,contents", "hypos_GOODSLST", "GDSNO = {0}", "", null, strWhereParameterArray3, CommandOperationType.ExecuteReaderReturnDataTable);
			if (dataTable3.Rows.Count <= 0)
			{
				return;
			}
			foreach (DataRow row in dataTable3.Rows)
			{
				...
				DataTable dataTable4 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "distinct pestId", "HyScope", "pesticideId={0} and cropId ={1} and formCode={2} and contents={3} AND isDelete in ('N','') ", "", null, strWhereParameterArray4, CommandOperationType.ExecuteReaderReturnDataTable);
				...
				{
					if (row2["pestId"].ToString().Length < level3length)
					{
						continue;
					}
					bool flag = false;
					...
					DataTable dataTable5 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "distinct cat3,name", "HyBlight", "{0} like '%'||cat1||cat2||cat3||'%' and cat1={1} and cat2 ={2} and cat3 !='' and cat4 =''", "", null, strWhereParameterArray5, CommandOperationType.ExecuteReaderReturnDataTable);
					...
					foreach (DataRow row3 in dataTable5.Rows)
					{
						...
						if (!flag)
						{
							...
							pestcls3.Add(row3["cat3"].ToString());
						}
						flag = false;
					}
				}
		...
		private void clslit3_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (clslit3.CurrentRow.Index == 0 && clslit3.CurrentRow.Cells[0].Value.ToString().Contains("選入"))
			{
				...
				{
					string str = "Non";
					DataTable dataTable5 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "licType,domManufId", "hypos_GOODSLST", "GDSNO={0}", "", null, strWhereParameterArray, CommandOperationType.ExecuteReaderReturnDataTable);
					foreach (DataRow row in dataTable2.Rows)
					{
						if (row["licType"].ToString().Equals(dataTable5.Rows[0]["licType"].ToString()) && row["licNo"].ToString().Equals(dataTable5.Rows[0]["domManufId"].ToString()))
						{
							flag = true;
						}
						else
					...
					if (flag)
					{
						if (Program.SystemMode == 1)
						{
							frs.addOnecommodity(barcode, cropcode, cls1 + cls2, dataTable3.Rows[0]["name"].ToString(), dataTable4.Rows[0]["name"].ToString());
							Hide();
							frs.setfocus();
							frs.Show();
						}
						...
						{
							frsm.addOnecommodity(barcode, cropcode, cls1 + cls2, dataTable3.Rows[0]["name"].ToString(), dataTable4.Rows[0]["name"].ToString());
							Hide();
							frsm.setfocus();
							frsm.Show();
						}
			...
			DataTable dataTable6 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "domManufId,pesticideId,formCode,contents", "hypos_GOODSLST", "GDSNO = {0}", "", null, strWhereParameterArray5, CommandOperationType.ExecuteReaderReturnDataTable);
			...
			{
				string[] strWhereParameterArray6 = new string[4]
				{
				...
				DataTable dataTable7 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "distinct pestId", "HyScope", "pesticideId={0} and cropId={1} and formCode={2} and contents={3} AND isDelete in ('N','') ", "", null, strWhereParameterArray6, CommandOperationType.ExecuteReaderReturnDataTable);
				...
				foreach (DataRow row3 in dataTable7.Rows)
				{
					...
					bool flag2 = false;
					string[] strWhereParameterArray7 = new string[4]
					{
					...
					DataTable dataTable8 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "distinct cat4,name", "HyBlight", "{0} like '%'||cat1||cat2||cat3||cat4||'%' and cat1={1} and cat2 ={2} and cat3={3} and cat4 !=''", "", null, strWhereParameterArray7, CommandOperationType.ExecuteReaderReturnDataTable);
		...
		private void clslit4_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (clslit4.CurrentRow.Index == 0 && clslit4.CurrentRow.Cells[0].Value.ToString().Contains("選入"))
			{
				...
				if (dataTable2.Rows.Count > 0)
				{
					...
					if (flag)
					{
						if (Program.SystemMode == 1)
						{
							frs.addOnecommodity(barcode, cropcode, cls1 + cls2 + cls3, dataTable3.Rows[0]["name"].ToString(), dataTable4.Rows[0]["name"].ToString());
							Hide();
							frs.setfocus();
							frs.Show();
						}
						...
						{
							frsm.addOnecommodity(barcode, cropcode, cls1 + cls2 + cls3, dataTable3.Rows[0]["name"].ToString(), dataTable4.Rows[0]["name"].ToString());
							Hide();
							frsm.setfocus();
							frsm.Show();
						}
			...
			bool flag2 = false;
			DataTable dataTable6 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "licType,domManufId,pesticideId,formCode,contents", "hypos_GOODSLST", "GDSNO = {0}", "", null, strWhereParameterArray5, CommandOperationType.ExecuteReaderReturnDataTable);
			if (dataTable6.Rows.Count <= 0)
			{
				return;
			}
			string[] strWhereParameterArray6 = new string[6]
			{
				dataTable6.Rows[0]["pesticideId"].ToString(),
				dataTable6.Rows[0]["formCode"].ToString(),
				dataTable6.Rows[0]["contents"].ToString(),
				cropcode,
				cls1 + cls2 + cls3 + cls4,
				text2
			};
			DataTable dataTable7 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "hl.licType,hl.licNo,hl.domManufName", "HyScope as hs,HyLicence as hl", "hs.pesticideId = {0} and hl.pesticideId = hs.pesticideId  and hs.formCode ={1} and hl.formCode = hs.formCode and hl.contents = hs.contents  and hs.contents={2} and hs.cropId ={3} and hs.pestId={4} and hs.approveDate != '' and (hs.approveDate +19190000) >=CAST ({5} as INTEGER) and hs.regStoreName !='' and  hs.regStoreName !='99999999' and hl.domManufId = hs.regStoreName AND hs.isDelete in ('N','')  ", "", null, strWhereParameterArray6, CommandOperationType.ExecuteReaderReturnDataTable);
			string[] strWhereParameterArray7 = new string[1]
			{
				cropcode
			};
			DataTable dataTable8 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "name", "HyCrop", "code = {0}", "", null, strWhereParameterArray7, CommandOperationType.ExecuteReaderReturnDataTable);
			string[] strWhereParameterArray8 = new string[1]
			{
				cls1 + cls2 + cls3 + cls4
			};
			DataTable dataTable9 = (DataTable)DataBaseUtilities.DBOperation(Program.ConnectionString, TableOperation.Select, "name", "HyBlight", "code = {0}", "", null, strWhereParameterArray8, CommandOperationType.ExecuteReaderReturnDataTable);
			if (dataTable7.Rows.Count > 0)
			{
				string str2 = "Non";
				...
				{
					if (row2["licType"].ToString().Equals(dataTable10.Rows[0]["licType"].ToString()) && row2["licNo"].ToString().Equals(dataTable10.Rows[0]["domManufId"].ToString()))
					{
						flag2 = true;
					}
					else
				...
				if (flag2)
				{
					if (Program.SystemMode == 1)
					{
						frs.addOnecommodity(barcode, cropcode, cls1 + cls2 + cls3 + cls4, dataTable8.Rows[0]["name"].ToString(), dataTable9.Rows[0]["name"].ToString());
						Hide();
						frs.setfocus();
						frs.Show();
					}
					...
					{
						frsm.addOnecommodity(barcode, cropcode, cls1 + cls2 + cls3 + cls4, dataTable8.Rows[0]["name"].ToString(), dataTable9.Rows[0]["name"].ToString());
						Hide();
						frsm.setfocus();
						frsm.Show();
					}
		...
		private void InitializeComponent()
		{
			...
			button1.Font = new System.Drawing.Font("新細明體", 14.25f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 136);
			button1.Location = new System.Drawing.Point(860, 110);
			...
			panel3.Location = new System.Drawing.Point(260, 38);
			panel3.Name = "panel3";
			...
			panel1.Location = new System.Drawing.Point(11, 38);
			panel1.Name = "panel1";
			...
			base.Name = "frmPestGuideRangeForSearch";
