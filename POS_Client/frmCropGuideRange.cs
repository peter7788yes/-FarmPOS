...
{
	public class frmCropGuideRange : MasterThinForm
	{
		public string cls1 = "";
		...
		public frmCropGuideRange()
			: base("收銀作業")
		{
		}

		public frmCropGuideRange(frmMainShopSimple fms, int count, string barcode1)
			: base("收銀作業")
		{
			frs = fms;
			this.count = count;
		...
		public frmCropGuideRange(frmMainShopSimpleWithMoney fms, int count, string barcode1)
			: base("收銀作業")
		{
			frsm = fms;
			this.count = count;
		...
		private void clslit2_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (clslit2.CurrentRow.Index == 0 && clslit2.CurrentRow.Cells[0].Value.ToString().Contains("選入"))
			{
				cropcode = cls1;
				nowlevel = 1;
				frmPestGuideRange frmPestGuideRange = (Program.SystemMode != 1) ? new frmPestGuideRange(this, frsm, count, barcode) : new frmPestGuideRange(this, frs, count, barcode);
				frmPestGuideRange.Location = new Point(base.Location.X, base.Location.Y);
				frmPestGuideRange.Show();
				Hide();
				return;
			}
		...
		private void clslit4_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
			if (e.RowIndex != -1)
			{
				...
				else
				{
					...
					nowlevel = 4;
					frmPestGuideRange frmPestGuideRange2 = (Program.SystemMode != 1) ? new frmPestGuideRange(this, frsm, count, barcode) : new frmPestGuideRange(this, frs, count, barcode);
					frmPestGuideRange2.Location = new Point(base.Location.X, base.Location.Y);
					frmPestGuideRange2.Show();
					Hide();
				}
			}
		}
		...
		private void InitializeComponent()
		{
			...
			button1.Location = new System.Drawing.Point(871, 123);
